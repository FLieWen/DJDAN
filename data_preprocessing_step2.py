...
#         # 更新加权均值
#         weighted_mean = beta * weighted_mean + (1 - beta) * data[i]
#         # 更新加权方差
#         weighted_var = beta * weighted_var + (1 - beta) * (data[i] - weighted_mean) ** 2
...
#             standardized_data[i] = (data[i] - weighted_mean) / weighted_std
#         else:
#             standardized_data[i] = 0  # 或者设置为某个固定值

#     return standardized_data

# # 定义文件夹路径
# # data_folder = 'BCIIV2b_mat'
# # standardized_data_folder = 'Standardized_BCIIV2b_mat'
