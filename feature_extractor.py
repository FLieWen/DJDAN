...
#         x = self.bn(x)
#         x = x ** 2                 # 平方激活
#         x = self.avg_pool(x)       # 平均池化，输出大小 (batch_size, 40, 61)
#         x = torch.log(x + 1e-6)    # 取对数以防 log(0)
#         x = self.dropout(x)        # Dropout
#         return x

# # 定义数据文件夹路径
# data_folder = 'data/E_Standardized_BCIIV2b_mat'
# filtered_data_folder = 'data/E_feature_extractor_BCIIV2b_mat'
...
# # 保存训练好的特征提取器模型
# model_save_path = 'E_feature_extractor.pth'
# torch.save(model.state_dict(), model_save_path)
